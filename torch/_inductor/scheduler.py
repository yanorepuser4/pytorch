...
class ForeachKernelSchedulerNode(FusedSchedulerNode):
    ...
    def fuse(
        ...
        use_custom_partition_algo = (
            typing.cast(ForeachKernelSchedulerNode, producer).use_custom_partition_algo
            if producer.is_foreach()
            else typing.cast(
                ForeachKernelSchedulerNode, consumer
            ).use_custom_partition_algo
        )
        prev_node_1 = None
        prev_node_2 = None
    ...
    def create_foreach_nodes(self) -> None:
        ...
        for names in V.graph.lists.values():
            ...
            fe_node = ForeachKernelSchedulerNode(
                self, snodes, use_custom_partition_algo=False
            )
